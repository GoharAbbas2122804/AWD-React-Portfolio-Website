  ...
  const demoSections = [
    {
      ...
      title: "Let's Connect",
      subtitle: "Worldwide",
      description: "Whether you're across the street or across the globe, I'm just a message away. Let's collaborate and bring your ideas to life with innovative solutions that make a difference.",
      align: "left" as const,
      actions: [
        { label: "Send Message", variant: "primary" as const, onClick: () => window.location.href = "mailto:goharabbas@example.com" },
        { label: "View Projects", variant: "secondary" as const, onClick: () => window.location.href = "/projects" },
      ]
    },
    {
      id: "innovation",
      ...
      description: "From startups to enterprises, I work with clients worldwide to create exceptional digital experiences. Every project is an opportunity to push boundaries and deliver solutions that exceed expectations.",
    ...
    },
    {
      ...
      title: "What I",
      subtitle: "Can Do",
      description: "With expertise spanning full-stack development, I transform ideas into reality. From concept to deployment, I deliver scalable, modern solutions tailored to your unique needs.",
      align: "left" as const,
      features: [
        { title: "Full-Stack Development", description: "End-to-end web applications with React, Node.js, and modern frameworks" },
        { title: "UI/UX Design", description: "Beautiful, intuitive interfaces that users love to interact with" },
        { title: "Consulting & Strategy", description: "Technical guidance to help you make the right technology decisions" }
      ]
    },
    {
      id: "future",
      ...
      description: "I'm always excited to hear about new projects and opportunities. Whether you have a clear vision or just an idea, let's discuss how we can work together to create something amazing.",
      align: "center" as const,
      actions: [
        { label: "Email Me", variant: "primary" as const, onClick: () => window.location.href = "mailto:goharabbas@example.com" },
        { label: "Download Resume", variant: "secondary" as const, onClick: () => console.log("Download resume") }
      ]
    }
  ];
