  ...
  return (
    <div className="relative w-full bg-black text-white overflow-hidden">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 h-screen pt-24">
        ...
        {/* Features section with variants */}
        <motion.div
        ...
        >
          <motion.div variants={itemVariants}>
            <FeatureItem name="React/Nextjs" value="for base" position="left-0 sm:left-10 top-40" />
          </motion.div>
          <motion.div variants={itemVariants}>
            <FeatureItem name="Tailwind" value="for styles" position="left-1/4 top-24" />
          </motion.div>
          <motion.div variants={itemVariants}>
            <FeatureItem name="Framer-motion/GSAP" value="for animations" position="right-1/4 top-24" />
          </motion.div>
          <motion.div variants={itemVariants}>
            <FeatureItem name="Shadcn" value="UI Components" position="right-0 sm:right-10 top-40" />
          </motion.div>
        </motion.div>
        ...
        >
          ...
          >
            <a href='/contact'><span>Join me for free </span></a>
          ...
          >
            Crafting amazing web experiences with cutting edge technologies.
          </motion.p>
